function [P1, P2,P3,V1,V2,V3]=kinematic2(z,slip)
q1 = z(1);
qd1 = z(4);
q2 = z(2);
qd2 = z(5);
...
P2 =[w+l2*(cos(q1)*cos(q2) - sin(q1)*sin(q2)) + l1*cos(q1);
l2*(cos(q1)*sin(q2) + cos(q2)*sin(q1)) + l1*sin(q1)];

P3 =[w+l2*(cos(q1)*cos(q2) - sin(q1)*sin(q2)) + l1*cos(q1) + l3*(cos(q3)*(cos(q1)*cos(q2) - sin(q1)*sin(q2)) - sin(q3)*(cos(q1)*sin(q2) + cos(q2)*sin(q1)));
